...
class Ptb(Dataset):
    ...
    def _download(self, file_name):
        file_path = self.dataset_dir + '/../downloads/' + file_name
    ...
    def load_vocab(self):
        vocab_path = self.dataset_dir + '/../downloads/' + self.vocab_file
    ...
    def load_data(self, data_type='train'):
        ...
        save_path = self.dataset_dir + '/../downloads/' + self.save_file[data_type]
